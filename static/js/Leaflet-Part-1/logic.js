...
function chooseColor(depth) {
    switch(true) {
        case (depth <= 10):
            return "#1E90FF"; // Shallow depths in Dodger Blue
        case (depth <= 30):
            return "#32CD32"; // Medium depths in Lime Green
        case (depth <= 50):
            return "#FFD700"; // Deeper depths in Gold
        case (depth <= 70):
            return "#FF8C00"; // Deeper depths in Dark Orange
        case (depth <= 90):
            return "#B22222"; // Deepest depths in Firebrick
        default:
            return "#8B0000"; // Default color in Dark Red
    }
}
